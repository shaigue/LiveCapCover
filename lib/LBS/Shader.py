...
class ShaderProgram:
    def __init__(self, vertex_file='lib/LBS/glsl/vertexShader.glsl', fragment_file='lib/LBS/glsl/fragmentShader.glsl'):
    ...
    def load_view_matrix(self, view_matrix: np.ndarray):
        load_uniform_matrix(self.view_matrix_location, view_matrix)

    def load_joint_transforms_array(self, joint_transforms):
